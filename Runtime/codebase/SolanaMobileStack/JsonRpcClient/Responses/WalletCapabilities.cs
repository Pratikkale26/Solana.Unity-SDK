...
public class WalletCapabilities
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="WalletCapabilities"/> class.
    /// </summary>
    /// <remarks>
    /// Parameterless constructor retained for JSON deserialization and preserved to prevent Unity code stripping.
    /// </remarks>
    [Preserve]
